...
- **Leitlinien**: Nachschlage-Ansicht aller 73 expliziten Leitlinien-Empfehlungskarten, gruppiert nach der jeweils konkreten Leitlinie (z.B. alle Empfehlungen der Surviving Sepsis Campaign zusammen, auch wenn sie ursprünglich aus unterschiedlichen Modulen stammen) – deckt alle klinisch relevanten Module vollständig ab (ERC, ESAIC, ASA, ESRA/ASRA, KDIGO, ESPEN, PADIS, Surviving Sepsis Campaign, DAS, ATLS, ISBI, Brain Trauma Foundation, ASH, EHRA, NICE, WHO Surgical Safety Checklist u.a.). Pro Leitlinie: alle Empfehlungen sequenziell "durchgehen", sich mit den passenden Testfragen "testen" oder die Leitlinie als "gelernt" abhaken.
...
Aktuell enthalten: **607 Karteikarten** (davon 129 Medikamenten-Steckbriefe, 73 explizite Leitlinien-Empfehlungskarten mit vollständiger Abdeckung aller klinisch relevanten Module), **320 Testfragen**, **6 Notfall-Algorithmen**, **14 Physiologie-Mechanismen** (eigene Rubrik), **7 Vergleichstabellen** (inkl. Organsysteme im Überblick) und **16 mündliche SOE-Übungsszenarien** für Teil 2, verteilt auf 42 Unterthemen in 10 Modulen.
