...
Aktuell enthalten: **971 Karteikarten** (davon 129 Medikamenten-Steckbriefe, 427 explizite Leitlinien-Empfehlungskarten gruppiert nach 42 Einzelleitlinien mit jeweils mindestens 5, meist 9-16 vertiefenden Karten statt nur einer Randnotiz), **508 Testfragen**, **6 Notfall-Algorithmen**, **28 Physiologie-Mechanismen** (eigene Rubrik, alle Organsysteme), **9 Vergleichstabellen** (inkl. Klassifikationssysteme/Scores und Inhalationsanästhetika) und **19 mündliche SOE-Übungsszenarien** für Teil 2, verteilt auf 42 Unterthemen in 10 Modulen.
