...
window.TABLES = [
  {
    ...
    rows: [
      ...
      ["Levosimendan", "Ca2+-Sensitizer + K_ATP-Kanal-Öffner (Inodilatator)", "Inotropie + Vasodilatation, kaum erhöhter O2-Verbrauch", "0,05–0,2 µg/kg/min (meist ohne Bolus)", "Akute Herzinsuffizienz, v.a. bei Betablocker-Vorbehandlung"],
      ...
      ["Terlipressin", "V1-Rezeptor (lang wirksames Vasopressin-Analogon)", "Vasokonstriktion (splanchnisch betont)", "1–2mg Bolus alle 4–6h", "Hepatorenales Syndrom, ösophageale Varizenblutung, therapierefraktärer septischer Schock (off-label)"]
    ]
  },
  {
    id: "muskelrelaxanzien",
    title: "Muskelrelaxanzien im Überblick",
    columns: ["Substanz", "Typ", "Intubationsdosis", "Wirkeintritt", "Wirkdauer", "Elimination", "Reversal"],
    rows: [
      ["Succinylcholin", "Depolarisierend", "1–1,5mg/kg", "30–60s", "5–10min", "Pseudocholinesterase", "Keines spezifisch"],
      ["Rocuronium", "Aminosteroid", "0,6mg/kg (RSI 1,2mg/kg)", "60–90s (RSI)", "30–60min", "Hepatisch", "Sugammadex"],
      ["Vecuronium", "Aminosteroid", "0,08–0,1mg/kg", "2,5–3min", "30–40min", "Hepatisch/renal", "Sugammadex"],
      ["Pancuronium", "Aminosteroid", "0,08–0,1mg/kg", "2–4min", "60–120min (lang)", "Renal (~80%)", "Sugammadex/Neostigmin"],
      ["Atracurium", "Benzylisochinolin", "0,5mg/kg", "2–3min", "20–35min", "Hofmann-Elimination (organunabhängig)", "NUR Neostigmin (kein Sugammadex!)"],
      ["Cisatracurium", "Benzylisochinolin", "0,15–0,2mg/kg", "~2min", "~45min", "Hofmann-Elimination (organunabhängig)", "NUR Neostigmin (kein Sugammadex!)"],
      ["Mivacurium", "Benzylisochinolin", "0,15–0,2mg/kg", "2–3min", "15–20min (kürzeste)", "Pseudocholinesterase", "Neostigmin"]
    ]
  },
  {
    id: "lokalanaesthetika",
    title: "Lokalanästhetika im Überblick",
    columns: ["Substanz", "Typ", "pKa (Wirkeintritt↑)", "Wirkdauer", "Max. Einzeldosis", "Besonderheit"],
    rows: [
      ["Lidocain", "Amid", "7,9", "1–2h", "3–4,5 mg/kg (7 mg/kg mit Adrenalin)", "Geringstes LAST-Risiko der Amide"],
      ["Bupivacain", "Amid", "8,1", "4–8h (lang)", "~2 mg/kg", "Höchste Kardiotoxizität ('fast-in, slow-out')"],
      ["Levobupivacain", "Amid (S-Enantiomer)", "8,1", "4–8h", "150 mg", "Geringere Kardiotoxizität als Bupivacain"],
      ["Ropivacain", "Amid (S-Enantiomer)", "8,1", "4–6h", "2,5–3 mg/kg", "Sensomotorische Dissoziation, geringere Toxizität"],
      ["Prilocain", "Amid", "7,9", "1–2h", "8,5 mg/kg", "Methämoglobinämie-Risiko (Antidot Methylenblau)"],
      ["Mepivacain", "Amid", "7,6", "1,5–3h", "6–7 mg/kg", "Keine intrinsische Vasodilatation"],
      ["Tetracain", "Ester", "8,5", "2–4h (spinal)", "~20mg (Schleimhaut)", "Höchste Toxizität, PABA-Allergiepotenzial"]
    ]
  },
  {
    id: "antidote",
